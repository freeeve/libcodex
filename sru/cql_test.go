...
func TestQueryString(t *testing.T) {
	cases := []struct {
		...
		{"isbn", Term("isbn", "9780142437247"), `bath.isbn = "9780142437247"`},
		{"issn", Term("issn", "0028-0836"), `bath.issn = "0028-0836"`},
		{"lccn", Term("lccn", "2004545455"), `bath.lccn = "2004545455"`},
		{"dotted passthrough", Term("bath.possessingInstitution", "DLC"), `bath.possessingInstitution = "DLC"`},
